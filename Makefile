...
run:
	@qemu-system-x86_64 -no-shutdown -no-reboot -m 1024M -smp 2 -cpu max --enable-kvm -cdrom bin/TFOS_ISO.iso -display gtk -s -d cpu_reset,int,pcall,unimp $(EXTRAARGS) -serial stdio
